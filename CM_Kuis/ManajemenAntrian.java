...
public class ManajemenAntrian {
    ...
    public void tambahAntrianPrioritas(String nama, String noHp) {
        Node NodePrioritas = new Node(new Pembeli(nama, noHp), counter);

        if (headAntrian == null) {
            headAntrian = tailAntrian =  NodePrioritas;
        } else {
            Node temp = headAntrian.next;
            headAntrian.next = NodePrioritas;
            headAntrian.next.next = temp;
        }
    }
